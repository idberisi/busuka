    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Jalur Add</h3>
            </div>
            <?php echo form_open('jalur/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_halte" class="form-control">
								...
								{
									$selected = ($halte['id'] == $this->input->post('id_halte')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_rute" class="form-control">
								...
								{
									$selected = ($rute['id'] == $this->input->post('id_rute')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="urutan" value="<?php echo $this->input->post('urutan'); ?>" class="form-control" id="urutan" />
